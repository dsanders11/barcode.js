...
goog.scope(function() {
  ...
  /** @final */
  Version.VERSION_DECODE_INFO = new Int32Array([0x07C94, 0x085BC, 0x09A99,
    0x0A4D3, 0x0BBF6, 0x0C762, 0x0D847, 0x0E60D, 0x0F928, 0x10B78, 0x1145D,
    0x12A17, 0x13532, 0x149A6, 0x15683, 0x168C9, 0x177EC, 0x18EC4, 0x191E1,
  ...
  Version.VERSIONS = function() {
    return new Array(new Version(1, new Int32Array(0),
      ...
      new Version(2, new Int32Array([6, 18]), new ECBlocks(10, new ECB(1, 34)),
        new ECBlocks(16, new ECB(1, 28)), new ECBlocks(22, new ECB(1, 22)),
        new ECBlocks(28, new ECB(1, 16))),
      new Version(3, new Int32Array([6, 22]), new ECBlocks(15, new ECB(1, 55)),
        new ECBlocks(26, new ECB(1, 44)), new ECBlocks(18, new ECB(2, 17)),
        new ECBlocks(22, new ECB(2, 13))),
      new Version(4, new Int32Array([6, 26]), new ECBlocks(20, new ECB(1, 80)),
        new ECBlocks(18, new ECB(2, 32)), new ECBlocks(26, new ECB(2, 24)),
        new ECBlocks(16, new ECB(4, 9))),
      new Version(5, new Int32Array([6, 30]), new ECBlocks(26, new ECB(1, 108)),
        new ECBlocks(24, new ECB(2, 43)),
        new ECBlocks(18, new ECB(2, 15), new ECB(2, 16)),
        new ECBlocks(22, new ECB(2, 11), new ECB(2, 12))),
      new Version(6, new Int32Array([6, 34]), new ECBlocks(18, new ECB(2, 68)),
        new ECBlocks(16, new ECB(4, 27)), new ECBlocks(24, new ECB(4, 19)),
        new ECBlocks(28, new ECB(4, 15))),
      new Version(7, new Int32Array([6, 22, 38]), new ECBlocks(20, new ECB(2, 78)),
        new ECBlocks(18, new ECB(4, 31)),
        new ECBlocks(18, new ECB(2, 14), new ECB(4, 15)),
        new ECBlocks(26, new ECB(4, 13), new ECB(1, 14))),
      new Version(8, new Int32Array([6, 24, 42]), new ECBlocks(24, new ECB(2, 97)),
      ...
      new Version(9, new Int32Array([6, 26, 46]), new ECBlocks(30, new ECB(2, 116)),
      ...
      new Version(10, new Int32Array([6, 28, 50]),
      ...
      new Version(11, new Int32Array([6, 30, 54]), new ECBlocks(20, new ECB(4, 81)),
      ...
      new Version(12, new Int32Array([6, 32, 58]),
      ...
      new Version(13, new Int32Array([6, 34, 62]), new ECBlocks(26, new ECB(4, 107)),
      ...
      new Version(14, new Int32Array([6, 26, 46, 66]),
      ...
      new Version(15, new Int32Array([6, 26, 48, 70]),
      ...
      new Version(16, new Int32Array([6, 26, 50, 74]),
      ...
      new Version(17, new Int32Array([6, 30, 54, 78]),
      ...
      new Version(18, new Int32Array([6, 30, 56, 82]),
      ...
      new Version(19, new Int32Array([6, 30, 58, 86]),
      ...
      new Version(20, new Int32Array([6, 34, 62, 90]),
      ...
      new Version(21, new Int32Array([6, 28, 50, 72, 94]),
      ...
      new Version(24, new Int32Array([6, 28, 54, 80, 106]),
      ...
      new Version(25, new Int32Array([6, 32, 58, 84, 110]),
      ...
      new Version(26, new Int32Array([6, 30, 58, 86, 114]),
      ...
      new Version(27, new Int32Array([6, 34, 62, 90, 118]),
      ...
      new Version(28, new Int32Array([6, 26, 50, 74, 98, 122]),
      ...
      new Version(29, new Int32Array([6, 30, 54, 78, 102, 126]),
      ...
      new Version(30, new Int32Array([6, 26, 52, 78, 104, 130]),
      ...
      new Version(31, new Int32Array([6, 30, 56, 82, 108, 134]),
      ...
      new Version(32, new Int32Array([6, 34, 60, 86, 112, 138]),
      ...
      new Version(33, new Int32Array([6, 30, 58, 86, 114, 142]),
      ...
      new Version(34, new Int32Array([6, 34, 62, 90, 118, 146]),
      ...
      new Version(35, new Int32Array([6, 30, 54, 78, 102, 126, 150]),
      ...
      new Version(36, new Int32Array([6, 24, 50, 76, 102, 128, 154]),
      ...
      new Version(37, new Int32Array([6, 28, 54, 80, 106, 132, 158]),
      ...
      new Version(38, new Int32Array([6, 32, 58, 84, 110, 136, 162]),
      ...
      new Version(39, new Int32Array([6, 26, 54, 82, 110, 138, 166]),
      ...
      new Version(40, new Int32Array([6, 30, 58, 86, 114, 142, 170]),
